...
abstract class $SportsmanCopyWith<$Res> {
  ...
  $Res call(
      {int? id, String name, String surname, String patronymic, int category});
}
...
class _$_Sportsman implements _Sportsman {
  ...
  @override
  String toString() {
    return 'Sportsman(id: $id, name: $name, surname: $surname, patronymic: $patronymic, category: $category)';
  }
...
abstract class _Sportsman implements Sportsman {
  const factory _Sportsman(
      ...
      required final int category}) = _$_Sportsman;
